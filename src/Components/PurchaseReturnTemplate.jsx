...
function PurchaseReturnTemplate({data}) {
        ...
        <div className='InvoiceTemplate' id='invoiceTemplate'>
            <div className="invoiceContainer" id='invoiceContainer'>
                <div className="invoiceTop">
                    ...
                    <p>Invoice Ref: P.Invoice #{data.input?.invoiceRef?.number}</p>
                    </div>
                </div>
                ...
                <div className="customerDetails">
                    ...
                    <div className="addressInfos">
                        <p><b>Supplier Name:</b> {suppliers?.filter(item => item._id === data?.supplier?._id && item.id === data?.supplier?.id && item?.number === data?.supplier?.number).map(item => item?.displayName)}</p>
                ...
                <table className="itemsBought">
                    ...
                    <tbody>
                        ...
                        <tr style={{backgroundColor : 'rgba(211,211,211, 0.5)'}}>
                                <td className="element"><b>Net Payable</b></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td className='invoiceDetailAmount'></td>
                                <td className='value'><b>{(Number(data.netPayable)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</b></td>
                            </tr>
...
export default PurchaseReturnTemplate
