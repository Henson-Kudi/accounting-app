                    ...
                    <div className="recentAndBarChart">
                        <div className="recentTransactions">
                            <div className="totalPurchases">
                                ...
                                <p><span><b>Qty:</b></span>{totalEntriesQty}</p>
                                <p><span><b>Amount:</b></span>{totalEntriesAmount}</p>
                            </div>
                            <div className="totalPurchases">
                                <p><b>Total Exits</b></p>
                                <p><p><span><b>Qty:</b></span>{totalExitsQty}</p>
                                <p><span><b>Amount:</b></span>{totalExitsAmount}</p></p>
                            </div>
